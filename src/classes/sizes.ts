...
export const sizesClasses: Entries = {
  'w-0': 'width: 0px;',
  'w-px': 'width: 1px;',
  ...
  'size-0': 'width: 0px;\nheight: 0px;',
  'size-px': 'width: 1px;\nheight: 1px;',
  'size-0.5': 'width: 0.125rem;\nheight: 0.125rem;',
  'size-1': 'width: 0.25rem;\nheight: 0.25rem;',
  'size-1.5': 'width: 0.375rem;\nheight: 0.375rem;',
  'size-2': 'width: 0.5rem;\nheight: 0.5rem;',
  'size-2.5': 'width: 0.625rem;\nheight: 0.625rem;',
  'size-3': 'width: 0.75rem;\nheight: 0.75rem;',
  'size-3.5': 'width: 0.875rem;\nheight: 0.875rem;',
  'size-4': 'width: 1rem;\nheight: 1rem;',
  'size-5': 'width: 1.25rem;\nheight: 1.25rem;',
  'size-6': 'width: 1.5rem;\nheight: 1.5rem;',
  'size-7': 'width: 1.75rem;\nheight: 1.75rem;',
  'size-8': 'width: 2rem;\nheight: 2rem;',
  'size-9': 'width: 2.25rem;\nheight: 2.25rem;',
  'size-10': 'width: 2.5rem;\nheight: 2.5rem;',
  'size-11': 'width: 2.75rem;\nheight: 2.75rem;',
  'size-12': 'width: 3rem;\nheight: 3rem;',
  'size-14': 'width: 3.5rem;\nheight: 3.5rem;',
  'size-16': 'width: 4rem;\nheight: 4rem;',
  'size-20': 'width: 5rem;\nheight: 5rem;',
  'size-24': 'width: 6rem;\nheight: 6rem;',
  'size-28': 'width: 7rem;\nheight: 7rem;',
