...
export const layoutClasses: Entries = {
  ...
  @media (min-width: 640px) {
    .container {
      /* Estilos para el tamaño de pantalla s */
      max-width: 640px;
      margin-left: auto;
      margin-right: auto;
      padding-left: 2rem;
  ...
  @media (min-width: 768px) {
    .container {
      /* Estilos para el tamaño de pantalla m */
      max-width: 768px;
      margin-left: auto;
      margin-right: auto;
      padding-left: 2rem;
  ...
  @media (min-width: 1024px) {
    .container {
      /* Estilos para el tamaño de pantalla l */
      max-width: 1024px;
      margin-left: auto;
      margin-right: auto;
      padding-left: 2rem;
  ...
  @media (min-width: 1280px) {
    .container {
      /* Estilos para el tamaño de pantalla xl */
      max-width: 1280px;
      margin-left: auto;
      margin-right: auto;
      padding-left: 2rem;
